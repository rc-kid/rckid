...
build-utils/generate-font assets/fonts/Iosevka.ttf 16 2 librckid/assets/fonts
build-utils/generate-font assets/fonts/Iosevka.ttf 20 2 librckid/assets/fonts
build-utils/generate-font assets/fonts/Iosevka.ttf 32 2 librckid/assets/fonts
echo "Generating fonts (OpenDyslexic)..."
build-utils/generate-font assets/fonts/OpenDyslexic.otf 32 2 librckid/assets/fonts
build-utils/generate-font assets/fonts/OpenDyslexic.otf 48 2 librckid/assets/fonts
