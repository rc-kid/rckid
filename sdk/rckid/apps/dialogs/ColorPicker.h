...
namespace rckid {
    ...
    public:
        ...
        {
            red_ = g_.addChild(new ui::ProgressBar{Rect::XYWH(10, 12, 200, 16), 0, 255, initialColor.r()});
            green_ = g_.addChild(new ui::ProgressBar{Rect::XYWH(10, 40, 200, 16), 0, 255, initialColor.g()});
            blue_ = g_.addChild(new ui::ProgressBar{Rect::XYWH(10, 68, 200, 16), 0, 255, initialColor.b()});
            preview_ = g_.addChild(new ui::Panel{Rect::XYWH(238, 12, 72, 72)});
