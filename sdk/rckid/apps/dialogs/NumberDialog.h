...
namespace rckid {
     ...
     */
    class NumberDialog : public ui::Form<int32_t> {
    public:

        String name() const override { return "NumberDialog"; }

        String title() const override { return placeholder_; }

        NumberDialog(char const * placeholder = "Enter number"):
    ...
    protected:
        ...
        void drawKeyboard() {
            tileMap_->text(0, 2) << " 1 2 3 4 5 - \x1e ";
            tileMap_->text(0, 3) << " 6 7 8 9 0 - \x18 ";
        }
