...
namespace rckid {
    ...
    public:
        ...
        {
            d_ = g_.addChild(new ui::Label{Rect::XYWH(0, 20, 90, 76), ""});
            m_ = g_.addChild(new ui::Label{Rect::XYWH(110, 20, 50, 76), ""});
            y_ = g_.addChild(new ui::Label{Rect::XYWH(180, 20, 150, 76), ""});
            dow_ = g_.addChild(new ui::Label{Rect::XYWH(0, 8, 110, 32), ""});
            mon_ = g_.addChild(new ui::Label{Rect::XYWH(120, 8, 200, 32), ""});
            sep1_ = g_.addChild(new ui::Label{Rect::XYWH(90, 20, 20, 76), "/"});
            sep2_ = g_.addChild(new ui::Label{Rect::XYWH(160, 20, 20, 76), "/"});
