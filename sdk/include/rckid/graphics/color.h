...
namespace rckid {
    ...
    constexpr Color::RGB565 Palette256[] = {
        ...
        Color::RGB(0x00, 0x00, 0x00),
        Color::RGB(0x00, 0x11, 0x00),
        Color::RGB(0x00, 0x22, 0x00),
        Color::RGB(0x00, 0x33, 0x00),
        Color::RGB(0x00, 0x44, 0x00),
        Color::RGB(0x00, 0x55, 0x00),
        Color::RGB(0x00, 0x66, 0x00),
        Color::RGB(0x00, 0x77, 0x00),
        Color::RGB(0x00, 0x88, 0x00),
        Color::RGB(0x00, 0x99, 0x00),
        Color::RGB(0x00, 0xaa, 0x00),
        Color::RGB(0x00, 0xbb, 0x00),
        Color::RGB(0x00, 0xcc, 0x00),
        Color::RGB(0x00, 0xdd, 0x00),
