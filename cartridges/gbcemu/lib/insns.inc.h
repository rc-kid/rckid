...
INS(0x22, _,_,_,_, 1, 8 , "ld [hl+], a", { write8(HL, A); ++HL; })
...
INS(0x2a, _,_,_,_, 1, 8 , "ld a, [hl+]", { A = read8(HL); ++HL; })
...
INS(0x32, _,_,_,_, 1, 8 , "ld [hl-], a", { write8(HL, A); --HL; })
...
INS(0x3a, _,_,_,_, 1, 8 , "ld a, [hl-]", { A = read8(HL); --HL; })
